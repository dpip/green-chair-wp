    ...
    <div class="container">
        <?php if ( have_posts() ) : ?>
            ...
            <?php while ( have_posts() ) : the_post(); 
                ...
                $the_content = ucfirst(wp_trim_words( get_the_content(), 55, '...'). ' <a class="result-link" href="'.$the_link.'"> Read More &raquo;</a>'); ?>
                <h4 class="result-title"><a href="<?php echo $the_link; ?>" /><?php echo $the_title;?></a></h4>
                <p class="result-content"><?php echo $the_content;?> </p>
                <hr />
